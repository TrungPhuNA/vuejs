<template>
    <div>
        ...
        <button v-on:click="$emit('handleHoldScore')" class="control btn-hold"><i class="ion-ios-download-outline"></i>Hold</button>
...
<script>
    export default {
        ...
        methods : {
            newGame() {
                // kich hoat su kien handleNewGame o app truyen vao
                console.log("init new game: Compoentn Controls")
                this.$emit('handleNewGame')
            },
            rollDice() {
                console.log("RollDice Controls ");
